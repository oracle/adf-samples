...
public class EmpImpl extends EntityImpl {
  ...
  public EmpImpl() {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = (EntityDefImpl)EntityDefImpl.findDefObject("test.model.entities.Emp");
        }
   ...
   */
  public void setEmpno(DBSequence value) {
   ...
   * takes care of the post ordering for you.
   */
  public void postChanges(TransactionEvent e) {
    DeptImpl dept = getDept();
    if (dept != null) {
      if (dept.getPostState() == Entity.STATUS_NEW) {
        dept.postChanges(e);        
      }
    }
    super.postChanges(e);
