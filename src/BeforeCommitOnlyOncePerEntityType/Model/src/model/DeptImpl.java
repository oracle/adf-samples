...
package model;
import model.common.TwoDepartmentsBothHaveXXInNameException;
...
public class DeptImpl extends CustomEntityImpl {
  ...
  //  System.out.println("Dname got set to "+getDname());
  }
  ...
  /**
   * Insure that no two Dept entities have an "XX" in their name
   * using a view object for validation purposes.
   */
  public void validateEntityCollectionBeforeCommit(TransactionEvent e) 
  {
    if (getCountValidationVOResult("model.CountXXDeptNames") > 1) {
      throw new TwoDepartmentsBothHaveXXInNameException();
    }
  }
