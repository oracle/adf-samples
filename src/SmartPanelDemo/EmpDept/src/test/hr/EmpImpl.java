...
public class EmpImpl extends EntityImpl  {
  ...
  public static final int MGREMP = 8;
  public static final int DEPT = 9;
  public static final int EMP = 10;
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (mDefinitionObject == null) {
      mDefinitionObject = (EntityDefImpl)EntityDefImpl.findDefObject("test.hr.Emp");
    }
  ...
  /**
   * 
   * Gets the associated entity EmpImpl
   */
  public EmpImpl getMgrEmp() {
    return (EmpImpl)getAttributeInternal(MGREMP);
  }

  /**
   * 
   * Sets <code>value</code> as the associated entity EmpImpl
   */
  public void setMgrEmp(EmpImpl value) {
    setAttributeInternal(MGREMP, value);
  }
