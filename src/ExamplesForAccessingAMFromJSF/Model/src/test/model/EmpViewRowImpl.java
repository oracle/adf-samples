...
// ---------------------------------------------------------------------
public class EmpViewRowImpl extends ViewRowImpl implements EmpViewRow {
    /**
    ...
    public void customViewRowMethodNoArgs() {
        System.out.println("##> Called customViewRowMethodNoArgs() ["+currentRowString()+"]");
    }
    public void customViewRowMethod(String stringArg, Integer intArg) {
        System.out.println("##> Called customViewRowMethod("+stringArg+","+intArg+") ["+currentRowString()+"]");
    }

    private String currentRowString() {
        return "Current row has key "+getKey();
    }
    public String customViewRowMethodWithResult(String stringArg, Integer intArg) {
        System.out.println("##> Called customViewRowMethodWithResult("+stringArg+","+intArg+") ["+currentRowString()+"]");
