...
//  ---------------------------------------------------------------------
public class EmpImpl extends MyEntityImpl {
  ...
  /**
   * Returns false if associated Dept entity has a Dname value of "XXX".
   * @return
   */
  public boolean validateThatDepartmentNotNamedXXX() {
    DeptImpl d = getDept();
    if ((d != null) && "XXX".equalsIgnoreCase(d.getDname())) {
      return false;
    }
    return true;
  }
