...
public class EmpImpl extends EntityImpl 
{
  ...
  /**
   * Overridden framework method to mark a "Deleted" field with "Y" instead
   * of really removing the deleted row. Also see the overridden remove()
   * method, which sets the deleted flag.
   */
  public void remove() {
    /**
     * Set the deleted flag attribute to "Y" and set the operation
     * to perform an update instead before calling super.
     */
    setDeleted("Y");
    super.remove();
  }
  ...
  protected void doDML(int operation, TransactionEvent e) {
    /*
     * If this entity is being asked to delete itself from the database...
     */
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = (EntityDefImpl)EntityDefImpl.findDefObject("devguide.advanced.markdel.Emp");
    }
