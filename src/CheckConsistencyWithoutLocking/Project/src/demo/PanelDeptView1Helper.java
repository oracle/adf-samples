...
public class PanelDeptView1Helper extends JPanel implements JUPanel {
  ...
  public void jbInit() throws Exception {
    ...
    dataPanel.add(mLoc, 
                  new CellConstraints(4, 6, 1, 1, CellConstraints.DEFAULT, 
                                      CellConstraints.FILL));dataPanel.add(jButton1,
                  new CellConstraints(4, 9, 1, 1, CellConstraints.DEFAULT,
    ...
    mLoc.setColumns(15);
    jButton1.setText("testConsistencyOfCurrentRow");
    ...
    jButton1.setModel((ButtonModel)panelBinding.bindUIControl("testConsistencyOfCurrentRow",jButton1));
  }
  private JUPanelBinding panelBinding = new JUPanelBinding("PanelDeptView1HelperPageDef");
  private JPanel dataPanel = new JPanel();
  private BorderLayout borderLayout = new BorderLayout();
  private JUNavigationBar navBar = new JUNavigationBar();
  private FormLayout panelLayout = new FormLayout("f:3dlu:n, r:d:g, f:5dlu:n, f:d:g, f:5dlu:n", "c:3dlu:n, c:d:n, c:3dlu:n, c:d:n, c:3dlu:n, c:max(d;15dlu):n, c:d:n, c:3dlu:n, c:max(d;15dlu):n, c:3dlu:n");
  ...
  public static void main(String [] args) {
    ...
    panel.setBindingContext(JUTestFrame.startTestFrame("demo.DataBindings.cpx", "null", panel, panel.getPanelBinding(), new Dimension(400,300)));
    panel.revalidate();
  }
