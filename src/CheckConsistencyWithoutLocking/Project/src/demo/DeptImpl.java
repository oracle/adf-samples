...
public class DeptImpl extends CustomEntityImpl {
  ...
  public static final int SOMETRANS = 2;
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (mDefinitionObject == null) {
      mDefinitionObject = (EntityDefImpl)EntityDefImpl.findDefObject("demo.Dept");
    }
  ...
  /**Gets the attribute value for SomeTrans, using the alias name SomeTrans
   */
  public String getSomeTrans() {
    return (String)getAttributeInternal(SOMETRANS);
  }

  /**Sets <code>value</code> as the attribute value for SomeTrans
   */
  public void setSomeTrans(String value) {
    setAttributeInternal(SOMETRANS, value);
  }
