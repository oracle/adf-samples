 ...
 */
public class DataObjectActiveDataModel
  extends ActiveDataModelDecorator
  implements ActiveDataObjectChangeListener
{
  ...
  public DataObjectActiveDataModel()
  {
    super();    
  }

  public DataObjectActiveDataModel(String reportId, String graphBindingId)
  {
    super();    
  ...
  {    
    ...
    graphData = (DataModel) treeData.getDataModel();
