...
import test.fwkext.CustomEntityImpl;
// ---------------------------------------------------------------------
...
public class EmpImpl extends CustomEntityImpl {
  ...
  public static final int TOTALCOMP = 8;
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (mDefinitionObject == null) {
      mDefinitionObject = (EntityDefImpl)EntityDefImpl.findDefObject("test.model.Emp");
    }
  ...
  /**Gets the attribute value for TotalComp, using the alias name TotalComp
   */
  public Number getTotalComp() {
    return nvl(getSal()).add(nvl(getComm()));
  }
