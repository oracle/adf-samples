...
public class FormEmployeesView1 extends JFrame 
{
  // form layout
...
// The status bar
  ...
  private PanelEmployeesView1 dataPanel = new PanelEmployeesView1();
...
// menu definitions
  ...
  public void jbInit() throws Exception
  {
    ...
    this.setSize(new Dimension(469, 365));
  ...
  public static void main(String [] args)
  {
    ...
    try
    {
      ...
      app.getApplicationModule().fetchAttributeProperties(new String[] {"EmployeesView1"}, new String[][] {{"LastName", "FirstName", "EmployeeId", "Email"}}, null);
      FormEmployeesView1 frame = new FormEmployeesView1();
  ...
  private int _popupTransactionDialog()
  {
    ...
    if (panelBinding.isTransactionDirty())
    {
      ...
      int action = JOptionPane.showOptionDialog(FormEmployeesView1.this, "How do you want to close the transaction?", "Transaction open", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE, null, options, options[(0)]);
