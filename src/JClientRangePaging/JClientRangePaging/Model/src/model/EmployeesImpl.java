...
public class EmployeesImpl extends EntityImpl 
{
  ...
  public static final int DEPARTMENTS = 12;
  public static final int EMPLOYEES = 13;
  public static final int DEPARTMENTSMANAGED = 14;
  public static final int JOBHISTORY = 15;
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (mDefinitionObject == null) {
      mDefinitionObject = (EntityDefImpl)EntityDefImpl.findDefObject("model.Employees");
    }
  ...
  protected Object getAttrInvokeAccessor(int index, AttributeDefImpl attrDef) throws Exception
  {
    switch (index)
      ...
      case EMPLOYEES:
        return getEmployees();
      case DEPARTMENTSMANAGED:
        return getDepartmentsManaged();
      case JOBHISTORY:
  ...
  private boolean hasSubordinates() {
    return getEmployees().first() != null;
  }

  private boolean managesDepartments() {
    return getDepartmentsManaged().first() != null;
  }
  ...
  public void remove() {
    if (!hasSubordinates() && !managesDepartments()) {
      ...
      throw new JboException(getFirstName()+" "+getLastName()+
      " managed a department or has subordinates!");
    }
  }
