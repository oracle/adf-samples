...
public class EmpImpl extends EntityImpl {
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (mDefinitionObject == null) {
      mDefinitionObject = (EntityDefImpl)EntityDefImpl.findDefObject("xml2000demo.Emp");
    }
    return mDefinitionObject;
  }


  public boolean validateSalaryNotBelow100(Number value) {
    // Salary must be greater than 100
    if ((value != null) && (value.floatValue() < 100)) {
      return false;
    }    
    return true;
  }
  public boolean validateSalaryNotMoreThanThousandTimesName() {
    String name = getEname();
    Number sal = getSal();
    if ((sal != null) && (name != null) &&
          (sal.floatValue() > (1000 * name.length()))) {
      return false;
    }
    return true;
  }
  ...
  public void create(AttributeList attributeList) {
    ...
    setSal(new oracle.jbo.domain.Number(500));
  }
