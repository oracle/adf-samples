...
public class EmpImpl extends EntityImpl {
  ...
  private static EmpDefImpl mDefinitionObject;

  /**This is the default constructor (do not remove)
   */
  public EmpImpl() {
    EmpDefImpl.linkEvents( );
  }
  ...
  public static synchronized EntityDefImpl getDefinitionObject() {
    if (mDefinitionObject == null) {
      mDefinitionObject = (EmpDefImpl)EntityDefImpl.findDefObject("test.Emp");
    }
    return mDefinitionObject;
  }
  public void handleOnChangeDnameOrLocOfDepartment(String newDname, String newLoc, Number Deptno) {
    System.out.println("### Emp "+getKey()+" notified of handleOnChangeDnameOrLoc event.");
  }
  ...
  /**Handles the event OnDnameOrLocChanged
   */
  public void DeptOnDnameOrLocChanged_Handler(JboEventObject e) {
    handleOnChangeDnameOrLocOfDepartment((String)e.get("Dname"), 
                                         (String)e.get("Loc"), 
                                         (Number)e.get("Deptno"));
