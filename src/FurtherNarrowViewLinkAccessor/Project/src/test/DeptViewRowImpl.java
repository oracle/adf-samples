...
public class DeptViewRowImpl extends ViewRowImpl {
  ...
  public static final int DEPARTMENTSTAFF = 3;
  ...
  /**Gets the associated <code>RowIterator</code> using master-detail link DepartmentStaff
   */
  public RowIterator getDepartmentStaff() {
    return (RowIterator)getAttributeInternal(DEPARTMENTSTAFF);
  }
