...
<adf:uimodelreference model="testPageUIModel" lifecycle="test.view.TestPageHandler" />
<html>
<head>
...
<body>
  <a href="testPage.jsp?event=Previous">Previous</a>
  <a href="testPage.jsp?event=Next">Next</a>
