...
//  ---------------------------------------------------------------------
public class EmpImpl extends CustomEntityImpl {
  ...
  // ----------[Begin User-Written Code]--------------------------------
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = (EntityDefImpl)EntityDefImpl.findDefObject("demo.model.businessobjects.Emp");
        }
        return mDefinitionObject;
    }

    /**
     * Exposes a helper method that DeptImpl can use to refresh the
     * Empno primary key attribute with the database-trigger-assigned value
     * 
     * @param id
     */
  void refreshEmpNo(BigDecimal id) {
    populateAttribute(EMPNO, new DBSequence(id), true, false, false);
  }
  /**
   * Overridden framework method to short-circuit any EmpImpl-specific DML
   * by commenting out the call to super.doDML()
   * @param e Transaction event
   * @param operation DML operation flag
   */
  ...
  // ----------[End User-Written Code]----------------------------------
     ...
     */
  public DBSequence getEmpno() {
    return (DBSequence) getAttributeInternal(EMPNO);
  }
  /**
   *
  ...
  public void setDept(DeptImpl value) {
     ...
     */
    public static Key createPrimaryKey(DBSequence empno) {
