...
public class DeptImpl extends EntityImpl {
    ...
    public static final int TRANSIENTNUMBERATTRIBUTE = 3;
    ...
    protected Object getAttrInvokeAccessor(int index, 
        ...
        case LOC:
            return getLoc();
        case TRANSIENTNUMBERATTRIBUTE:
            return getTransientNumberAttribute();
        default:
    ...
    protected void setAttrInvokeAccessor(int index, Object value, 
        ...
        case LOC:
            ...
            return;
        case TRANSIENTNUMBERATTRIBUTE:
            setTransientNumberAttribute((Number)value);
            return;
        default:
    ...
    /**Validation method for Dept
     */
    public boolean validateDept() {
        if (getDname().equalsIgnoreCase("X") && getLoc().equalsIgnoreCase("Y")) {
            return false;
        }
        return true;
    }

    /**Gets the attribute value for TransientNumberAttribute, using the alias name TransientNumberAttribute
     */
    public Number getTransientNumberAttribute() {
        return (Number)getAttributeInternal(TRANSIENTNUMBERATTRIBUTE);
    }

    /**Sets <code>value</code> as the attribute value for TransientNumberAttribute
     */
    public void setTransientNumberAttribute(Number value) {
        setAttributeInternal(TRANSIENTNUMBERATTRIBUTE, value);
    }
