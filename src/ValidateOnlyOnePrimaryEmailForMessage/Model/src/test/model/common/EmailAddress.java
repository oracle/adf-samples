...
// ---    Wed Nov 04 13:01:03 CET 2009
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class EmailAddress implements DomainInterface, Serializable {
  ...
  protected void validate() {
    ...
    if ((atpos == -1) || (dotpos == -1) || // there is no "@" or no "."
     ...
     {
      DataCreationException dce =  new DataCreationException(ErrorMessages.class,
