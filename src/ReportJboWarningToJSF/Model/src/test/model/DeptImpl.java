...
public class DeptImpl extends EntityImpl {
  ...
  public void setDname(String value) {
    ...
    if (value != null && value.equalsIgnoreCase("WARN")) {
      getDBTransaction().getRootApplicationModule().addWarning(new JboWarning("You've caused a warning for department "+getDname()));
    }
  }
  ...
  public void afterCommit(TransactionEvent e) {
    super.afterCommit(e);
    getDBTransaction().getRootApplicationModule().addWarning(new InformationalMessage("Department "+getDeptno()+" saved successfully."));
  }
