...
public class EmpViewRowImpl extends ViewRowImpl 
{
  ...
  public static final int SUMOFSAL = 8;
  /**
   * 
  ...
  {
    ((EmpViewImpl)getViewObject()).recalculateSumOfSal();
  ...
  /**
   * 
   *  Gets the attribute value for the calculated attribute SumOfSal
   */
  public Number getSumOfSal()
  {
    return ((EmpViewImpl)getViewObject()).getSumOfSal();
  }

  /**
   * 
   *  Sets <code>value</code> as the attribute value for the calculated attribute SumOfSal
   */
  public void setSumOfSal(Number value)
  {
    setAttributeInternal(SUMOFSAL, value);
  }
}
