...
public final class startAdminCommand extends Command {
    public startAdminCommand() {
        super(actionId());
    }
    ...
    public static int actionId() {
        final Integer cmdId = Ide.findCmdID("shay.glassfish.startadmin");
        if (cmdId == null)
            throw new IllegalStateException("Action shay.glassfish.startadmin not found.");
        return cmdId;
    }
}
