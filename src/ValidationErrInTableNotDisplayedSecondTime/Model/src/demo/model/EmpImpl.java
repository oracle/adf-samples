...
public class EmpImpl extends EntityImpl {
  ...
  /**
   * Fail validation if Sal < Comm
   * @return
   */
  public boolean validateCommIsNotGreaterThanSal() {
    Number sal = getSal();
    Number comm = getComm();
    if (sal != null && comm != null && sal.compareTo(comm) < 0) {
      return false;
    }
    return true;
  }

  private static final Number N40   = new Number(40);
   private static final Number N1000 = new Number(1000);
   private static final Number N1500 = new Number(1500);
   /**
    * Validate that Dept 40 employees must be SALESMAN or CLERK
    */
   public boolean validateIfDeptIs40ThenJobIsSalesmanOrClerk() {
     if (getDeptno().equals(N40) && !(getJob().equals("SALESMAN") || getJob().equals("CLERK"))) {
       return false;
     }
     return true;
   }
   ...
   /**
    * Validate that Dept 40 SALESMAN must have sal 1500
    */
   public boolean validateDept40SalesmanMustHaveSal1500() {
     if (getDeptno().equals(N40) && getJob().equals("SALESMAN") &&!getSal().equals(N1500)) {
       return false;
     }
     return true;
   }
   ...
   /**
    * Validate that Dept 40 CLERK must have sal of 1000
    */
   public boolean validateDept40ClerkMustHaveSal1000() {
     if (getDeptno().equals(N40) && getJob().equals("CLERK") && !getSal().equals(N1000)) {
       return false;
     }
     return true;
   }
