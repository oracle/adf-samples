      ...
      <h:form>
        <af:panelPage title="#{res[view.viewId]}">
          ...
          <af:panelGroup>
            ...
            <af:objectSeparator/>
            <af:messages/>
            <af:inputHidden value="#{SigninPage.returnOutcome}"/>
            <af:panelForm>
            ...
            <af:panelGroup layout="vertical">
              <af:commandButton text="Login"
                                disabled="#{!bindings.validSignon.enabled}"
                                action="#{SigninPage.onLogin}"/>
              <af:panelGroup>
                <af:outputText value="Are you a new user?"/>
                <af:commandLink text="Register for a new account"
                                action="register" immediate="true"/>
              </af:panelGroup>
            </af:panelGroup>
          </af:panelGroup>
        </af:panelPage>
